...
def _setup_lib_path():
    lib_path = os.path.join(SCRIPT_DIR, '../_lib')
...
def main():
    ...
    parser.add_argument("--output-dir",   required=False, help="Output directory (default: outputs/resumes/)")
    ...
    output_dir = args.output_dir or os.path.join(project_root, "outputs", "resumes")
