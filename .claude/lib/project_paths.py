...
def get_postings_dir():
    ...
    Returns:
        str: Path to outputs/postings/
    """
    project_root = get_project_root()
    postings_dir = os.path.join(project_root, "outputs", "postings")
...
def get_jobs_csv():
    """
    Get the path to the application tracker.

    Returns:
        str: Path to .claude/state/applications.md
    """
    project_root = get_project_root()
    return os.path.join(project_root, ".claude", "state", "applications.md")
